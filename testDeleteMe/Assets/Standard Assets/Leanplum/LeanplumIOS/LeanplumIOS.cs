...
namespace LeanplumSDK
{
	public class LeanplumIOS: LeanplumSDKObject
	{
		...
		[DllImport ("__Internal")]
		internal static extern void _track(string _event, double value, string info, string dictStringJSON);

		[DllImport ("__Internal")]
		internal static extern void _setApiHostName(string hostName, string servletName, int useSSL);
		...
		public override void SetUserAttributes(string newUserId, IDictionary<string, object> attributes)
		{
			string attributesString = attributes == null ? null : Json.Serialize(attributes);
		...
		public override Var<Dictionary<string, object>> Define(string name, Dictionary<string, object> defaultValue)
		{
			...
			return (cached != null) ? (Var<Dictionary<string, object>>) cached :
				new IOSVar<Dictionary<string, object>>(name, Constants.Kinds.DICTIONARY, defaultValue);
		}
		
		public override Var<Dictionary<string, string>> Define(string name, Dictionary<string, string> defaultValue)
		{
			Var cached = GetOrDefineVariable(name, Constants.Kinds.DICTIONARY, defaultValue);
			return (cached != null) ? (Var<Dictionary<string, string>>) cached :
				new IOSVar<Dictionary<string, string>>(name, Constants.Kinds.DICTIONARY, defaultValue);
		}
