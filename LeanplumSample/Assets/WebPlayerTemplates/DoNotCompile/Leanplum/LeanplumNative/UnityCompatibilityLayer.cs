...
namespace LeanplumSDK
{
    internal class UnityCompatibilityLayer : ICompatibilityLayer
    {
        ...
        /// <param name="defaultValue">The default value if the setting has no value, or is the wrong type.</param>
        /// <returns>System.Object. Either returns the correctly typecast object, or defaultValue.</returns>
