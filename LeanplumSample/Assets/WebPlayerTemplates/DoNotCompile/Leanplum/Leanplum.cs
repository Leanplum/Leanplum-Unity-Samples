...
namespace LeanplumSDK
{
	...
	public static class Leanplum
	{
		...
		/// 	UIApplication methods to register notifications and does not call anything within the Leanplum SDK.
		/// 	This will register for alerts, sounds, and badges.
		/// 	If you'd like to register with different settings, you can use your own method for registering instead.
		/// </summary>
		...
		/// <param name="purchaseData">Purchase data from com.android.vending.billing.util.Purchase.getOriginalJson().</param>
		/// <param name="dataSignature">Purchase data signature from com.android.vending.billing.util.Purchase.getSignature().</param>
		/// <param name="parameters">Optional event parameters.</param>
		public static void TrackGooglePlayPurchase(string item, long priceMicros, string currencyCode, string purchaseData,
		...
		/// </summary>
		/// <param name="item">The name of the item purchased.</param>
		/// <param name="unitPrice">The purchase price (from [[SKProduct price] doubleValue].</param>
		/// <param name="quantity">The quantity (from [[SKPaymentTransaction payment] quantity].</param>
		/// <param name="currencyCode">The ISO 4217 currency code (from [SKProduct priceLocale].</param>
		/// <param name="transactionIdentifier">Transaction identifier from [SKPaymentTransaction transactionIdentifier].</param>
		/// <param name="receiptData">Receipt data from [[NSData dataWithContentsOfURL:[[NSBundle mainBundle] appStoreReceiptURL]] base64EncodedStringWithOptions:0].</param>
		/// <param name="parameters">Optional event parameters.</param>
		public static void TrackIOSInAppPurchase(string item, double unitPrice, int quantity, string currencyCode,
