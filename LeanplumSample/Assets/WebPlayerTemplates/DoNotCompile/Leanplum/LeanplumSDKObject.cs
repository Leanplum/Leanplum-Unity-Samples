...
namespace LeanplumSDK
{
	public abstract class LeanplumSDKObject
	{
		...
		public virtual void TrackGooglePlayPurchase(string item, long priceMicros, string currencyCode, string purchaseData,
		...
		/// <param name="parameters">Optional event parameters.</param>
		public virtual void TrackIOSInAppPurchase(string item, double unitPrice, int quantity, string currencyCode,
		...
		public abstract Var<AssetBundle> DefineAssetBundle(string name, bool realtimeUpdating = true,
